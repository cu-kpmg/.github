...
| **3. Live Coding Walkthrough** | 23 min | Write the CartService using Signals, add item push/pop methods, update catalog cards, and display cart headers. |
| **4. Check for Understanding** | 5 min | Q&A on signal mutability, computed evaluation caching, and zone-free rendering futures. |
| **5. Class Wrap-up & Checkpoint** | 3 min | Verify cart quantities and prices update dynamically across components. |
