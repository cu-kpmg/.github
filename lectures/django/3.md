...
|---------|----------|------------------------|
| **1. Hook & Big Picture** | 7 min | Define RESTful services. Compare standard Django views with Django REST Framework (DRF). |
| **2. Key Concepts & Core Ideas** | 7 min | Explain Serializers as translators, ViewSets vs APIViews, and routers. |
| **3. Live Coding Walkthrough** | 23 min | Configure settings, write serializers and viewsets, wire URLs, and test the endpoints. |
| **4. Check for Understanding** | 5 min | Q&A on serialization validation, viewset mappings, and security exclusions. |
| **5. Class Wrap-up & Checkpoint** | 3 min | Verify GET and POST requests are functional in the browsable API UI. |
