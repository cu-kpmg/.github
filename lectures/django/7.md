...
|---------|----------|------------------------|
| **1. Hook & Big Picture** | 10 min | Explain the webhooks model. Contrast polling vs. event-driven callbacks. |
| **2. Key Concepts & Core Ideas** | 10 min | Explain payload verification, HMAC, constant-time comparison, and JSON key sorting. |
| **3. Live Coding Walkthrough** | 15 min | Write the synchronous webhook helper, integrate it with the management command, and test. |
| **4. Discussion & Limitations** | 5 min | Analyze the failures of synchronous webhooks (blocking, timeout delays, no retry engine). |
| **5. Check for Understanding** | 5 min | Q&A on security signatures, response codes, and sync blockages. |
...
### 2. Key Concepts & Core Ideas (10 min)
...
### 3. Live Coding Walkthrough (15 min)
...
### 4. Discussion & Limitations (5 min)
...
### 6. Daily Checkpoint & Wrap-up (3 min)
