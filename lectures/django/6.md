...
|---------|----------|------------------------|
| **1. Hook & Big Picture** | 8 min | Define background tasks. Explain when to use management commands vs views or tasks. |
| **2. Key Concepts & Core Ideas** | 8 min | Explain `BaseCommand` methods, stdout redirection, batch ORM operations, and timezone filters. |
| **3. Live Coding Walkthrough** | 21 min | Create directories and files, implement `check_expired_keys` logic, run manually, and discuss cron configurations. |
| **4. Check for Understanding** | 5 min | Q&A on stdout vs print, `.update()` side effects, and crontab syntax. |
| **5. Class Wrap-up & Checkpoint** | 3 min | Verify expired keys are successfully processed by running the command in the terminal. |

---

## 🚀 Lecture Step-by-Step Delivery Plan

### 1. Hook & Big Picture (8 min)
...
### 2. Key Concepts & Core Ideas (8 min)
...
### 3. Live Coding Walkthrough (21 min)
